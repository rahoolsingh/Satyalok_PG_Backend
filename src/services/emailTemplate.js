...
<body style="
    ...
    <div style="max-width: 600px; margin: auto; background: #fff; padding: 30px; border-radius: 8px;">
        ...
        <div style="text-align: center; margin-bottom: 20px;">
            <img src="https://res.cloudinary.com/drd5iva1i/image/upload/b_rgb:FFFFFF/v1730919455/b965f91b-321f-4ed6-97f9-1908840d5731.png" alt="Quiz Champ Logo" style="max-width: 160px; height: auto;" />
        </div>
        ...
        <table style="width: 100%; font-size: 15px; border-collapse: collapse; margin-top: 20px;">
            <tr style="border-bottom: 1px solid #ddd;">
                <td style="padding: px;">Ref. No:</td>
                <td style="padding: 8px;"><strong>${refNumber}</strong></td>
            </tr>
            <tr style="border-bottom: 1px solid #ddd;">
                <td style="padding: px;">Txn. ID:</td>
                <td style="padding: 8px;">${transactionId}</td>
            </tr>
            <tr style="border-bottom: 1px solid #ddd;">
                <td style="padding: px;">Payment Time:</td>
                <td style="padding: 8px;">${paymentTime}</td>
            </tr>
            <tr style="border-bottom: 1px solid #ddd;">
                <td style="padding: px;">Amount Paid:</td>
                <td style="padding: 8px;">₹${amount}</td>
            </tr>
            <tr>
                <td style="padding: px;">Status:</td>
    ...
    <table class="es-footer" cellspacing="0" cellpadding="0" align="center" style="width: 100%; background-color: transparent">
        ...
        <tr>
            <td align="center" style="padding: 0; margin: 0">
                <table class="es-footer-body" style="
                            ...
                            <table class="es-content-body" style="
                                ...
                                <tr>
                                    ...
                                    <td style="
                                                background-color: #f7f7f7;
                                            " align="left">
                                        <a href="https://maps.app.goo.gl/LGb2dZXFRAye2CJ8A" target="_blank" style="text-decoration: none; color: #1376c8;">
                    ...
                    <tr>
                        <td align="center" style="padding: 0px 40px 40px">
                            <p style="text-align: center; font-size: 13px; color: red; padding-top: 20px; font-weight: bold;">
                            ...
                            <p style="
                                ...
                                anyone over phone, SMS or
                                email.
                                <a href="mailto:info@satyalok.in" style="
                                                            text-decoration: none;
                                                            color: #1376c8;
                                                        ">info@satyalok.in</a>.
                            </p>
                            ...
                            <p style="
                                                    ...
                                                    ">
                                Follow us on social media:
                                <a href="https://www.facebook.com/satyalok.official" style="
                                                            text-decoration: none;
                                                            color: #1376c8;
                                                        ">Facebook</a>
                                |
                                <a href="https://www.linkedin.com/company/satyalok/" style="
                                                            text-decoration: none;
                                                            color: #1376c8;
                                                        ">LinkedIn</a>
                                |
                                <a href="https://instagram.com/satyalok.official" style="
                                                            text-decoration: none;
                                                            color: #1376c8;
                                                        ">Instagram</a>
                            </p>
